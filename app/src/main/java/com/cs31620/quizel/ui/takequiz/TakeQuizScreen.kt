...
private fun TakeQuizScreen(
    ...
    TopLevelNavigationScaffold(
        ...
        ConstraintLayout(
            modifier = Modifier //holds the components of the screen
                .fillMaxSize()
            ...
            RecentScoresArea(scoresList = recentScores,
                modifier = Modifier.constrainAs(recentScoresDisplay) {
            ...
            Card(modifier = Modifier
                ...
                .fillMaxWidth() //holds the quiz options area
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(R.string.show_current_score), modifier = Modifier
                                .fillMaxHeight()
                                .wrapContentHeight(), fontSize = 20.sp
                        )
                    ...
                    Row(
                        modifier = Modifier //the switch for showing the current score
                            .padding(horizontal = 10.dp)
                            .height(50.dp)
                    ) {
                        Text(
                            text = stringResource(R.string.show_progress_bar), modifier = Modifier
                                .fillMaxHeight()
                                .wrapContentHeight(), fontSize = 20.sp
                        )
                        Spacer(modifier = Modifier.weight(1f))
            ...
            QuizelSimpleButton( //button to begin quiz
                onClick = {
                    val quizSettingsString =
                        //passes the settings for the quiz to the test questions screen
...
@Composable
private fun RecentScoresArea(scoresList: List<Score>, modifier: Modifier) {
    Card(
        modifier = modifier
            .shadow(10.dp, MaterialTheme.shapes.medium)
            .fillMaxWidth() //holds the recent scores area
        ...
        Column(
            ...
            RecentScoresDisplay(modifier = Modifier.fillMaxWidth(), scoresList = scoresList)
        }
    }
}
